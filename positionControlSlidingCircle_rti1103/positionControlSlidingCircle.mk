# =============================================================================
#  FILE:
#    positionControlSlidingCircle.mk
#
#  DESCRIPTION:
...
#
#  $RCSfile: positionControlSlidingCircle.mk $ $Revision: 2.39 $ $Date: 2009/11/23 16:13:00CET $
...
MAKEFILE                       = positionControlSlidingCircle.mk
...
COMPUTER                       = PCWIN
MODEL                          = positionControlSlidingCircle
MODULES                        = is_little_endian_rt.c positionControlSlidingCircle_data.c positionControlSlidingCircle_trc_ptr.c rtGetInf.c rtGetNaN.c rt_atan2_snf.c rt_nonfinite.c rt_pow_snf.c rt_zcfcn.c svd_d_rt.c svd_helper_rt.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = C:\Users\daq\Desktop\BOEING~1\POSITI~1\CIRCUL~1
# Shared library for utility code
RTW_SHARED_LIB_SRCS_WILD       = 
RTW_SHARED_LIB_SRCS_DIR        = 
RTW_SHARED_LIB_OBJS_DIR        = 
RTW_SHARED_LIB                 = 
RTW_MODELLIB                   = positionControlSlidingCirclelib.lib
...
RTWCUST_INCLUDES = \
	$(START_DIR)\positionControlSlidingCircle_rti1103 \
	$(START_DIR) \
	$(MATLAB_ROOT)\toolbox\dspblks\include
...
TMP_PATH_CC += $(MATLAB_ROOT)\toolbox\rtw\dspblks\c\dspsvd
TMP_PATH_CC += $(MATLAB_ROOT)\toolbox\rtw\dspblks\c\dspendian
TMP_PATH_CC += $(MATLAB_ROOT)\rtw\c\src
