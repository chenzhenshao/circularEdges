/************************ dSPACE target specific file *************************
   ...
   Include file .\positioncontrolslidingcircle_rti1103\positionControlSlidingCircle_th.c :

   Task Configuration file for model : positionControlSlidingCircle

   RTI1103 6.5 (10-May-2010)/2.2
   09-May-2017 11:04:09
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\positioncontrolslidingcircle_rti1103\positionControlSlidingCircle_th.c is for ST).
# endif
