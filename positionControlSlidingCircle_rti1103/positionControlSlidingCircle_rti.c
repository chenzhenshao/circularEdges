...
#define RTB_STRUCTURE_NAME             positionControlSlidingCircle_B
#define RTP_STRUCTURE_NAME             positionControlSlidingCircle_P
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  {
    Float64 pvalues[20];
    ds1103_adc_multi_conv_read(DS1103_ADC_CHANNEL19|DS1103_ADC_CHANNEL18|
      DS1103_ADC_CHANNEL17, pvalues);
    positionControlSlidingCircle_B.SFunction_m = pvalues[18];
    positionControlSlidingCircle_B.SFunction_g = pvalues[17];
    positionControlSlidingCircle_B.SFunction = pvalues[16];
  }

  /* dSPACE I/O Board DS1103 #1 Unit:ENC_POS Group:POS */
  positionControlSlidingCircle_B.SFunction1 = (real_T) ds1103_inc_position_read
    (1, DS1103_INC_LINE_SUBDIV_4);
  positionControlSlidingCircle_B.SFunction1_c = (real_T)
    ds1103_inc_position_read(2, DS1103_INC_LINE_SUBDIV_4);
  positionControlSlidingCircle_B.SFunction1_c2 = (real_T)
    ds1103_inc_position_read(3, DS1103_INC_LINE_SUBDIV_4);

  /* dSPACE I/O Board DS1103 #1 Unit:ENC_POS Group:DPOS */
  positionControlSlidingCircle_B.SFunction2 = (real_T)
    ds1103_inc_delta_position_read(1, DS1103_INC_LINE_SUBDIV_4);
  positionControlSlidingCircle_B.SFunction2_h = (real_T)
    ds1103_inc_delta_position_read(2, DS1103_INC_LINE_SUBDIV_4);
  positionControlSlidingCircle_B.SFunction2_l = (real_T)
    ds1103_inc_delta_position_read(3, DS1103_INC_LINE_SUBDIV_4);
}
