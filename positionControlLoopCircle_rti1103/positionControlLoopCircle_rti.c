/*********************** dSPACE target specific file *************************
   ...
   Include file positionControlLoopCircle_rti.c:
...
#define RTB_STRUCTURE_NAME             positionControlLoopCircle_B
#define RTP_STRUCTURE_NAME             positionControlLoopCircle_P
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  /* dSPACE I/O Board DS1103 #1 Unit:MultiAdc */
  {
    ...
    positionControlLoopCircle_B.SFunction_b = pvalues[18];
    positionControlLoopCircle_B.SFunction_a = pvalues[17];
    positionControlLoopCircle_B.SFunction = pvalues[16];
  }

  /* dSPACE I/O Board DS1103 #1 Unit:ENC_POS Group:POS */
  positionControlLoopCircle_B.SFunction1 = (real_T) ds1103_inc_position_read(3,
    DS1103_INC_LINE_SUBDIV_4);
  positionControlLoopCircle_B.SFunction1_b = (real_T) ds1103_inc_position_read(1,
    DS1103_INC_LINE_SUBDIV_4);
  positionControlLoopCircle_B.SFunction1_f = (real_T) ds1103_inc_position_read(2,
    DS1103_INC_LINE_SUBDIV_4);

  /* dSPACE I/O Board DS1103 #1 Unit:ENC_POS Group:DPOS */
  positionControlLoopCircle_B.SFunction2 = (real_T)
    ds1103_inc_delta_position_read(3, DS1103_INC_LINE_SUBDIV_4);
  positionControlLoopCircle_B.SFunction2_l = (real_T)
    ds1103_inc_delta_position_read(1, DS1103_INC_LINE_SUBDIV_4);
  positionControlLoopCircle_B.SFunction2_h = (real_T)
