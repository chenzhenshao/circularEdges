/************************ dSPACE target specific file *************************
   ...
   Include file .\positioncontrolloopcircle_rti1103\positionControlLoopCircle_th.c :

   Task Configuration file for model : positionControlLoopCircle

   RTI1103 6.5 (10-May-2010)/2.2
   24-Jan-2017 00:13:24
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\positioncontrolloopcircle_rti1103\positionControlLoopCircle_th.c is for ST).
# endif
